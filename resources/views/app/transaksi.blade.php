  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header pt-4">
        <p>Pada menu ini kita melakukan input transaksi pengeluaran atau pemasukan<p>
      </div>
      </div>
  </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" required="required" name="tanggal"  autocomplete="off" placeholder="Masukkan tanggal ..">
                  </div>
