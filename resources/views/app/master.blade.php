...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('stisla/node_modules/owl.carousel/dist/assets/owl.theme.default.min.css') }}">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="{{ route('logout') }}"
                                ...
                                class="dropdown-item has-icon"><i class="icon-key"></i>Logout</a>
                        </div>
                    </li>
                </ul>
            </nav>
